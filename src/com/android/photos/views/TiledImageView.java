...
public class TiledImageView extends FrameLayout {
    private static final String TAG = "TiledImageView";
    ...
    public TiledImageView(Context context, AttributeSet attrs) {
        ...
        if (USE_TEXTURE_VIEW) {
            ...
            mGLSurfaceView.setTag(R.id.ty_gl_tag, TAG);
            view = mGLSurfaceView;
        }
    ...
    public String getGLTag(){
        ...
        return (String)mGLSurfaceView.getTag(R.id.ty_gl_tag);
    }
    
    public void destroy() {
        if (mGLSurfaceView != null){
            BasicTexture.yieldAllTextures(getGLTag());
        }
        if (!IS_SUPPORTED) {
            return;
        }
