...
public abstract class MediaObject {
    ...
    public static final int SUPPORT_COLLECT = 1 << 18;
    public static final int SUPPORT_ADD_TO_ALBUM = 1 << 19;
    ...
    //public static final long MAX_MOVE_FILE_SIZE = 10 * 1024 * 1024;
    //TY zhencc end for New Design Gallery
    ...
    public static final int TY_NONE_MODE = 0;
    public static final int TY_DELETE_MODE = 1 << 0;
    public static final int TY_HIDE_MODE = 1 << 1;
    public static final int TY_SHOW_MODE = 1 << 2;
    public static final int TY_SHARE_MODE = 1 << 3;
