...
class ClusterSource extends MediaSource {
    ...
    static final int CLUSTER_TY_ALBUMSET_TIME = 5;
    ...
    /*TIANYU: yuxin add begin for New Design Gallery*/
    static final int CLUSTER_TY_ALBUM_TIME = 0x105;
    /*TIANYU: yuxin add end for New Design Gallery*/
    ...
    public ClusterSource(GalleryApp application) {
        ...
        /*TIANYU: yuxin add begin for New Design Gallery*/
        mMatcher.add("/cluster/*/tytime", CLUSTER_TY_ALBUMSET_TIME);
        /*TIANYU: yuxin add end for New Design Gallery*/
        ...
        /*TIANYU: yuxin add begin for New Design Gallery*/
        mMatcher.add("/cluster/*/tytime/*", CLUSTER_TY_ALBUM_TIME);
        /*TIANYU: yuxin add end for New Design Gallery*/
    }
