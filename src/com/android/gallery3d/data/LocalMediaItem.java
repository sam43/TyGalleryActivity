...
public abstract class LocalMediaItem extends MediaItem {
    ...
    //taoxj add begin
    public PictureDAOImpl dao = new PictureDAOImpl(GalleryAppImpl.getContext());
    //taoxj add end
    // database fields
    public int id;
    ...
    public long getDateInMs() {
        //taoxj add for cloud file date
        PictureDetail pd = dao.queryByPath(filePath);
        if(pd != null && pd.getTakePictureTime() != 0){
            return pd.getTakePictureTime();
        }
