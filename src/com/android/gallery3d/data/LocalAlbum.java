...
import com.android.gallery3d.datatask.UpdatePictureAsyncTask;
...
public class LocalAlbum extends MediaSet {
    ...
    private static final String[] SIZE_COLUMNS = { ImageColumns.SIZE };
    ...
    public long reload() {
        if (mNotifier.isDirty()) {
            ...
            //taoxj add for update picture.db begin
            Log.i("koala","updatePictureDatabase ==");
            new UpdatePictureAsyncTask().execute(mBaseUri);
            //taoxj add for update picture.db end
        }
        return mDataVersion;
    }
    ...
    public long getFileSize() {
        Cursor cursor = mResolver.query(
                mBaseUri, SIZE_COLUMNS, mWhereClause,
                new String[]{String.valueOf(mBucketId)}, null);
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                //if(size > MediaObject.MAX_MOVE_FILE_SIZE){
                //	    break;
                //}
            }
            return size;
    ...
    public static String getLocalizedName(Resources res, int bucketId,
        ...
        //TY zhencc 20150715 add for PROD103890821 begin
        }else if (bucketId == MediaSetUtils.ROOT_BUCKET_ID) {
            return res.getString(R.string.folder_root);
        //TY zhencc 20150715 add for PROD103890821 end
        }
        else {
            return name;
        }
