...
public class MediaSetUtils {
    ...
    public static final String ROOT_ALBUM_PATH = Environment.getExternalStorageDirectory()
    		.toString();
    
    public static final int ROOT_BUCKET_ID = GalleryUtils.getBucketId(ROOT_ALBUM_PATH);
