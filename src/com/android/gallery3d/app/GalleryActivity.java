...
public final class GalleryActivity extends AbstractGalleryActivity implements OnCancelListener {
    ...
    private void initializeByIntent() {
        ...
        if (Intent.ACTION_GET_CONTENT.equalsIgnoreCase(action)) {
            ...
            //startDefaultPage();
            startActivity(new Intent(this, TyGalleryActivity.class));
            finish();
    ...
    public void startDefaultPage() {
        ...
        data.putString(AlbumSetPage.KEY_MEDIA_PATH,
                getDataManager().getTopSetPath(DataManager.INCLUDE_LOCAL_CAMERA));
        //TIANYU:yuxin modify begin for New Design Gallery
    ...
    private void startGetContent(Intent intent) {
        ...
        //TY yuxin modify begin for New Design Gallery
        //getStateManager().startState(AlbumSetPage.class, data);
        getStateManager().startState(TyAlbumSetListPage.class, data);
        //TY yuxin modify end for New Design Gallery
    }
    ...
    private void startViewAction(Intent intent) {
        ...
        if (slideshow) {
            ...
            if (uri == null) {
                ...
                if (itemPath == null || TextUtils.isEmpty(itemPath.toString())){
                    Log.e(TAG, "startViewAction itemPath="+itemPath);
                    finish();
                    return;
                }
                data.putString(PhotoPage.KEY_MEDIA_ITEM_PATH, itemPath.toString());
                //TY liuyuchuan modify for PROD103689769 PhotoPage.KEY_READONLY:true--->false
    ...
    protected void onResume() {
        ...
        //TY wb034 20150608 add begin for PROD103796829
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_USER);
      //TY wb034 20150608 add end for PROD103796829
    }
