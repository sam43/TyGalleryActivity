...
public class MovieActivity extends Activity {
	...
	/*TIANYURD: wangzhg add for bt dialer begin */
	private static final String ACTION_BT_DIAL_SERVICECMD = "com.android.videoplayer.servicecmd";
	private static final String ACTION_BT_DIAL_PLAYSERVICE = "com.android.videoplayer.playservice";
	/*TIANYURD: wangzhg add for bt dialer end */
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (action.equals(Intent.ACTION_HEADSET_PLUG)) {
                ...
                mIsHeadsetOn = false;
			/*TIANYURD: wangzhg add for bt dialer begin */
            } else if (action.equals(ACTION_BT_DIAL_SERVICECMD) &&
                        SystemProperties.getBoolean("ro.ty.btdialer.support", false)) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //initializeActionBar(intent);//TY liuyuchuan delete begin for PROD103707450
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        /*TIANYURD:Lizhy 20150420 add for TOS3.0 VIDEO PLAYER start*/
        shareMenu.setVisible(false);
        /*TIANYURD:Lizhy 20150420 add for TOS3.0 VIDEO PLAYER end*/ 
    ...
    public void initEffects(int sessionId) {
        ...
        try{
            ...
            Log.e("TAG", "MovieActivity initEffects mBassBoostEffect="+mBassBoostEffect
                + " mVirtualizerEffect="+mVirtualizerEffect);
        }

        if (mBassBoostEffect == null || mVirtualizerEffect== null){
            return;
        }
    ...
    public void onPause() {
     ...
     //TIANYU hanpengzhe 20151214 add for statusbar icon color  begin
      //  getWindow().setStatusBarIconDark(true);
    ...
    public void onResume() {
        ...
        if ((mVirtualizerSupported) || (mBassBoostSupported)) {
			...
			if (SystemProperties.getBoolean("ro.ty.btdialer.support", false)) {
			    intentFilter.addAction(ACTION_BT_DIAL_SERVICECMD);
			}
			/*TIANYURD: wangzhg add for bt dialer begin */
     ...
     //TIANYU hanpengzhe 20151214 add for statusbar icon color  begin
      //  getWindow().setStatusBarIconDark(false);
    //TIANYU hanpengzhe 20151214 add for statusbar icon color  end
    }
    ...
    public void setActionBarTitle(String title) {
        ...
        if (actionBar != null && title != null) {
			...
			/*TIANYURD: wangzhg add for bt dialer begin */
			if (SystemProperties.getBoolean("ro.ty.btdialer.support", false)) {
			    mPlayer.sendBroadcastforbtdialer(ACTION_BT_DIAL_PLAYSERVICE, "name", title);
			}
			/*TIANYURD: wangzhg add for bt dialer end */			
        }
    }
