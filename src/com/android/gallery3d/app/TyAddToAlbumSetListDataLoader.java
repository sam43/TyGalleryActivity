...
public class TyAddToAlbumSetListDataLoader {
    @SuppressWarnings("unused")
    private static final String TAG = "Gallery2/TyAddToAlbumSetListDataLoader";
    ...
    public TyAddToAlbumSetListDataLoader(GalleryContext activity, MediaSet albumSet, int cacheSize) {	
