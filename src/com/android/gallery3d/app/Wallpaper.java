...
public class Wallpaper extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            mNoCloseScene = bundle.getBoolean(GalleryUtils.KEY_EX_TY_NO_CLOSESENCE, false);
        }else{
            mNoCloseScene = getIntent().getBooleanExtra(GalleryUtils.KEY_EX_TY_NO_CLOSESENCE, false);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle saveState) {
        ...
        if (mPickedItem != null) {
            ...
            saveState.putBoolean(GalleryUtils.KEY_EX_TY_NO_CLOSESENCE, mNoCloseScene);
        }
    }
    ...
    protected void onResume() {
        ...
        if (mNoCloseScene){
            Intent request = new Intent(Intent.ACTION_GET_CONTENT)
                    ...
                    .setType(IMAGE_TYPE);
            request.putExtra(GalleryUtils.KEY_EX_TY_NO_CLOSESENCE, true);
