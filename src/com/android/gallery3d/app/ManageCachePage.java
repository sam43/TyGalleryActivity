...
public class ManageCachePage extends ActivityState implements
    ...
    private GLView mRootPane = new GLView() {
        ...
        protected void onLayout(
            ...
            View footer = ((Activity)mActivity.getAndroidContext()).findViewById(R.id.footer);
            if (footer != null) {
                int location[] = {0, 0};
    ...
    public void onConfigurationChanged(Configuration config) {
        ...
        FrameLayout layout = (FrameLayout) ((Activity) mActivity.getAndroidContext()).findViewById(R.id.footer);
