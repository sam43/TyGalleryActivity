...
public class FilterUtils {
    ...
    public static final int CLUSTER_BY_TY_TIME = 64;
    ...
    public static void setupMenuItems(GalleryActionBar actionBar, Path path, boolean inAlbum) {
        ...
        /*TIANYU: yuxin add begin for New Design Gallery*/
        setMenuItemApplied(actionBar, CLUSTER_BY_TY_TIME,
                (ctype & CLUSTER_BY_TY_TIME) != 0, (ccurrent & CLUSTER_BY_TY_TIME) != 0);
        /*TIANYU: yuxin add end for New Design Gallery*/
    ...
    private static int toClusterType(String s) {
        ...
        /*TIANYU: yuxin add begin for New Design Gallery*/
        else if (s.equals("tytime")){
            return CLUSTER_BY_TY_TIME;
        }
        /*TIANYU: yuxin add end for New Design Gallery*/
        return 0;
    }
