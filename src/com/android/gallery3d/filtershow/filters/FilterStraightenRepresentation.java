...
//TIANYU hanpengzhe 20150704 add for PROD103855467 begin
import com.android.gallery3d.app.GalleryAppImpl;
//TIANYU hanpengzhe 20150704 add for PROD103855467 end
...
public class FilterStraightenRepresentation extends FilterRepresentation {
    ...
    public FilterStraightenRepresentation(float straighten) {
     //TIANYU hanpengzhe 20150704 modify for PROD103855467 begin
       // super(SERIALIZATION_NAME);
        //setSerializationName(SERIALIZATION_NAME);
        super(GalleryAppImpl.getContext().getString(R.string.straighten));
        setSerializationName(SERIALIZATION_NAME);
    //TIANYU hanpengzhe 20150704 modify for PROD103855467 end
