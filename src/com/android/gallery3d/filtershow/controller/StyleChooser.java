...
public class StyleChooser implements Control {
    ...
    int mSelectedButton = 0;//TY xumw 20160122 add for PROD104153696
    ...
    public void setUp(ViewGroup container, Parameter parameter, Editor editor) {
        ...
        mSelectedButton = mParameter.getSelected();//TY xumw 20160122 add for PROD104153696
        mIconButton.clear();
        ...
        for (int i = 0; i < n; i++) {
          ...
          //TY xumw 20160122 modify for PROD104153696 begin
           // button.setBackgroundResource(android.R.color.transparent);
            button.setBackgroundResource((mSelectedButton == i) ?R.drawable.ic_style_selected_background
          ...
          //TY xumw 20160122 modify for PROD104153696 begin
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    resetBorders(buttonNo);//TY xumw 20160122 add for PROD104153696
                }
            });
...
//TY xumw 20160122 add for PROD104153696 begin
    private void resetBorders(int buttonNo) {
        mSelectedButton = buttonNo;
        for (int i = 0; i < mIconButton.size(); i++) {
