...
public abstract class SurfaceTextureScreenNail implements ScreenNail,
    ...
    public SurfaceTextureScreenNail(GalleryContext galleryContext) {
         mGalleryContext = galleryContext;
    }

    public void acquireSurfaceTexture(GLCanvas canvas) {
        mExtTexture = new ExtTexture(canvas, GL_TEXTURE_EXTERNAL_OES, mGalleryContext.getGLTag(R.id.ty_gl_tag));
