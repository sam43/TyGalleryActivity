...
public class AlbumSetSlidingWindow implements AlbumSetDataLoader.DataListener {
    ...
    public AlbumSetSlidingWindow(GalleryContext activity,
    ...
    public BitmapTexture getLoadingTexture() {
        if (mLoadingLabel == null) {
            ...
            mLoadingLabel = new BitmapTexture(bitmap, mGalleryContext.getGLTag(R.id.ty_gl_tag));
    ...
    private class AlbumCoverLoader extends BitmapLoader implements EntryUpdater {
        ...
        public void updateEntry() {
            ...
            TiledTexture texture = new TiledTexture(bitmap, mTiledResources, mGalleryContext.getGLTag(R.id.ty_gl_tag));
            /*TIANYU: yuxin modify end for New Design Gallery**/
    ...
    private class AlbumLabelLoader extends BitmapLoader implements EntryUpdater {
        ...
        public void updateEntry() {
            ...
            AlbumSetEntry entry = mData[mSlotIndex % mData.length];
            BitmapTexture texture = new BitmapTexture(bitmap, mGalleryContext.getGLTag(R.id.ty_gl_tag));
