...
public class WakeLockHoldingProgressListener implements MenuExecutor.ProgressListener {
    ...
    public WakeLockHoldingProgressListener(GalleryContext galleryActivity) {
        this(galleryActivity, DEFAULT_WAKE_LOCK_LABEL);
    }

    public WakeLockHoldingProgressListener(GalleryContext galleryActivity, String label) {
        mActivity = galleryActivity;
        PowerManager pm =
                (PowerManager) ((Activity) mActivity.getAndroidContext()).getSystemService(Context.POWER_SERVICE);
    ...
    protected GalleryContext getActivity() {
        return mActivity;
    }
