...
public class UndoBarView extends GLView {
    ...
    //    +-+----+----------------+-+--+----+-+------+--+-+
    //     4  16                   1 12  32  8        16 4
    public UndoBarView(GalleryContext galleryContext) {
        ...
        mPanel = new NinePatchTexture(context, R.drawable.panel_undo_holo, glTag);
        mUndoText = StringTexture.newInstance(context.getString(R.string.undo),
                GalleryUtils.dpToPixel(12), GRAY, 0, true, glTag);
        mDeletedText = StringTexture.newInstance(
                context.getString(R.string.deleted),
                GalleryUtils.dpToPixel(16), WHITE, glTag);
        mUndoIcon = new ResourceTexture(
                context, R.drawable.ic_menu_revert_holo_dark, glTag);
