...
public class GLRootView extends GLSurfaceView
    ...
    private final ArrayList<OnGLChanegeListener> mChanegeListeners =
            new ArrayList<OnGLChanegeListener>();
    ...
    public void addOnGLIdleListener(OnGLIdleListener listener) {
        synchronized (mIdleListeners) {
            //yuxin modify begin for  New Design Gallery
    ...
    public void setContentPane(GLView content) {
        ...
        if (mContentView != null) {
            ...
            BasicTexture.yieldAllTextures((String)getTag(R.id.ty_gl_tag));
        }
    ...
    public void onSurfaceCreated(GL10 gl1, EGLConfig config) {
        ...
        try {
            ...
            BasicTexture.invalidateAllTextures((String)getTag(R.id.ty_gl_tag));
        } finally {
            mRenderLock.unlock();
        }
    ...
    //yuxin add begin for  New Design Gallery
    @Override
    public void addOnGLChanegeListener(OnGLChanegeListener listener) {
        synchronized (mChanegeListeners) {
            if (listener != null){
                mChanegeListeners.add(listener);
            }
        }
    }
    
    @Override
    public void removeOnGLChanegeListener(OnGLChanegeListener listener) {
        synchronized (mChanegeListeners) {
            if (listener != null){
                mChanegeListeners.remove(listener);
            }
        }
    }

    public void notifyGLChanege() {
        synchronized (mChanegeListeners) {
            for (OnGLChanegeListener listener : mChanegeListeners){
                listener.onGLChanege();
            }
        }
    }
    //yuxin add end for  New Design Gallery
