...
public class AlbumSetSlotRenderer extends AbstractSlotRenderer {
    ...
    public AlbumSetSlotRenderer(GalleryContext activity,
        ...
        mCameraOverlay = new ResourceTexture(activity.getAndroidContext(),
                R.drawable.ic_cameraalbum_overlay, activity.getGLTag(R.id.ty_gl_tag));
    }
