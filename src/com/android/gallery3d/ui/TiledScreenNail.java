...
public class TiledScreenNail implements ScreenNail {
    ...
    //}
    public TiledScreenNail(Bitmap bitmap, TiledTexture.Resources res, GalleryContext galleryContext) {
        mWidth = bitmap.getWidth();
        mHeight = bitmap.getHeight();
        mBitmap = bitmap;
        mTexture = new TiledTexture(bitmap, res, galleryContext.getGLTag(R.id.ty_gl_tag));
    }
