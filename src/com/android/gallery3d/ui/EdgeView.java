...
public class EdgeView extends GLView {
    ...
    public EdgeView(GalleryContext galleryContext) {
        for (int i = 0; i < 4; i++) {
            mEffect[i] = new EdgeEffect(galleryContext);
        }
    }
  ...
  //  TY 034 20150108 add begin for tygallery
    
    protected void render(GLCanvas canvas,int direction) {
        canvas.multiplyMatrix(mMatrix, direction * 16);
        mEffect[direction].draw(canvas);
    ...
    public void Absorb(int velocity, int direction) {
