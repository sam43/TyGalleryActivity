...
public class ActionModeHandler implements Callback, PopupList.OnPopupItemClickListener {
    ...
    public void startActionMode() {
        Activity a = (Activity)mActivity.getAndroidContext();
    ...
    private int computeMenuOptions(ArrayList<MediaObject> selected) {
        ...
        switch (selected.size()) {
            case 1:
                ...
                if (!GalleryUtils.isEditorAvailable(mActivity.getAndroidContext(), mimeType)) {
    ...
    private void setNfcBeamPushUris(Uri[] uris) {
        if (mNfcAdapter != null && ApiHelper.HAS_SET_BEAM_PUSH_URIS) {
            mNfcAdapter.setBeamPushUrisCallback(null, (Activity)mActivity.getAndroidContext());
            mNfcAdapter.setBeamPushUris(uris, (Activity)mActivity.getAndroidContext());
        }
    }
