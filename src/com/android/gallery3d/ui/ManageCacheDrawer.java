...
public class ManageCacheDrawer extends AlbumSetSlotRenderer {
    ...
    public ManageCacheDrawer(GalleryContext activity, SelectionManager selectionManager,
        ...
        String glTag = activity.getGLTag(R.id.ty_gl_tag);
        mCheckedItem = new ResourceTexture(
                context, R.drawable.btn_make_offline_normal_on_holo_dark, glTag);
        mUnCheckedItem = new ResourceTexture(
                context, R.drawable.btn_make_offline_normal_off_holo_dark, glTag);
        mLocalAlbumIcon = new ResourceTexture(
                context, R.drawable.btn_make_offline_disabled_on_holo_dark, glTag);
        String cachingLabel = context.getString(R.string.caching_label);
        mCachingText = StringTexture.newInstance(cachingLabel, 12, 0xffffffff, glTag);
