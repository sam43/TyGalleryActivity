...
public class ProgressSpinner {
    ...
    public ProgressSpinner(GalleryContext galleryContext) {
        Context context = galleryContext.getAndroidContext();
        String glTag = galleryContext.getGLTag(R.id.ty_gl_tag);
        mOuter = new ResourceTexture(context, R.drawable.spinner_76_outer_holo, glTag);
        mInner = new ResourceTexture(context, R.drawable.spinner_76_inner_holo, glTag);
