...
public class PreparePageFadeoutTexture implements OnGLIdleListener {
    ...
    //    mRootPane =  rootPane;
    //}
    public PreparePageFadeoutTexture(GLView rootPane, String glTag) {
        if (rootPane == null) {
            mCancelled = true;
            return;
        }
        ...
        mTexture = new RawTexture(w, h, true, glTag);
        mRootPane =  rootPane;
    }
    ...
    public static void prepareFadeOutTexture(GalleryContext activity,
            GLView rootPane) {
        //PreparePageFadeoutTexture task = new PreparePageFadeoutTexture(rootPane);
        PreparePageFadeoutTexture task = new PreparePageFadeoutTexture(rootPane, activity.getGLTag(R.id.ty_gl_tag));
