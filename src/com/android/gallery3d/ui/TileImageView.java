...
public class TileImageView extends GLView {
    ...
    //TY liuyuchuan modify  for  New Design Gallery ,Convert cX and cY  float
    ...
    //TY liuyuchuan modify  for  New Design Gallery ,Convert centerX and centerY  float
    ...
    private synchronized Tile obtainTile(int x, int y, int level) {
        ...
        return new Tile(x, y, level, mGalleryContext.getGLTag(R.id.ty_gl_tag));
    }
    ...
    private class Tile extends UploadedTexture {
        ...
        //    mTileLevel = level;
        //}
        public Tile(int x, int y, int level, String glTag) {
            super(glTag);
            mX = x;
            mY = y;
            mTileLevel = level;
