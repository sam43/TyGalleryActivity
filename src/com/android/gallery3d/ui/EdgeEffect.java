...
public class EdgeEffect {
     ...
     */
    public EdgeEffect(GalleryContext galleryContext) {
        Context context = galleryContext.getAndroidContext();
        String glTab = galleryContext.getGLTag(R.id.ty_gl_tag);
        mEdge = new Drawable(context, R.drawable.kt_overscroll_edge, glTab);
        mGlow = new Drawable(context, R.drawable.kt_overscroll_glow, glTab);
    ...
    public boolean draw(GLCanvas canvas) {
        ...
        //mGlow.setAlpha((int) (Math.max(0, Math.min(mGlowAlpha, 1)) * 255));//TY liuyuchuan delete 20150514
    ...
    private static class Drawable extends ResourceTexture {
        ...
        public Drawable(Context context, int resId, String glTag) {
            super(context, resId, glTag);
        }
