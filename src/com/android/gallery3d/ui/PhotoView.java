...
public class PhotoView extends GLView {
   ...
   // private static final boolean CARD_EFFECT = true;//TY wb034 20150109 modify this for tygallery
    ...
    public static final int TY_FALLBACK_EFFECT_MAX = 0;//SCREEN_NAIL_MAX
    ...
    public PhotoView(GalleryContext activity) {
        ...
        mUndoBar = new UndoBarView(activity);
        ...
        mNoThumbnailText = StringTexture.newInstance(
                ...
                DEFAULT_TEXT_SIZE, Color.WHITE, activity.getGLTag(R.id.ty_gl_tag));
        ...
        mVideoPlayIcon = new ResourceTexture(mContext, R.drawable.ic_control_play, activity.getGLTag(R.id.ty_gl_tag));
    ...
    private class MyGestureListener implements GestureRecognizer.Listener {
        ...
        public boolean onSingleTapUp(float x, float y) {
            ...
            if (mListener != null && getGLRoot() != null) {
    ...
    public PhotoFallbackEffect buildFallbackEffect(GLView root, GLCanvas canvas) {
        ...
        for (int i = -TY_FALLBACK_EFFECT_MAX; i <= TY_FALLBACK_EFFECT_MAX; ++i) {
            ...
            RawTexture texture;
            if ((rotation % 180) == 0) {
                texture = new RawTexture(width, height, true, mGalleryContext.getGLTag(R.id.ty_gl_tag));
                canvas.beginRenderTarget(texture);
                canvas.translate(width / 2f, height / 2f);
            } else {
                texture = new RawTexture(height, width, true, mGalleryContext.getGLTag(R.id.ty_gl_tag));
                canvas.beginRenderTarget(texture);
