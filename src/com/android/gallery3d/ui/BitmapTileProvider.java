...
public class BitmapTileProvider implements TileImageView.TileSource {
    ...
    public BitmapTileProvider(Bitmap bitmap, int maxBackupSize, GalleryContext galleryContext) {
        ...
        mScreenNail = new BitmapScreenNail(list.remove(list.size() - 1), galleryContext);
