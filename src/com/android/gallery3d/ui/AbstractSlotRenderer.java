...
public abstract class AbstractSlotRenderer implements SlotView.SlotRenderer {
    ...
    protected AbstractSlotRenderer(GalleryContext galleryContext) {
        ...
        mTyVideoOverlay = new ResourceTexture(context, R.drawable.ty_ic_album_video_thumb, glTag);
    }
    ...
    //}
    //TY zhen end for New Design Gallery
