...
class MultiLineTexture extends CanvasTexture {
    ...
    private MultiLineTexture(Layout layout, String glTag) {
        super(layout.getWidth(), layout.getHeight(), glTag);
        mLayout = layout;
    }

    public static MultiLineTexture newInstance(
            String text, int maxWidth, float textSize, int color,
            Layout.Alignment alignment, String glTag) {
        ...
        return new MultiLineTexture(layout, glTag);
    }
