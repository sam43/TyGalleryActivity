ifeq ("$(TYAPP_TYGALLERY_SUPPORT)","true")
...
LOCAL_STATIC_JAVA_LIBRARIES += ty.com.android.gallery3d.common2
...
LOCAL_JNI_SHARED_LIBRARIES := libjni_eglfence_ty libjni_filtershow_filters_ty librsjni libjni_jpegstream_ty
